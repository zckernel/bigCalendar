...
export const ROOM_COL_W   = 120;
export const BUFFER_DAYS  = 30;
export const FETCH_RANGE_DAYS    = 1000; // seed range
export const INITIAL_LOAD_DAYS   = 90;   // initial fetch ±days
export const CHUNK_DAYS          = 180;  // prefetch chunk size
export const PREFETCH_THRESHOLD  = 45;   // start prefetch when N days from loaded edge
export const EVICT_RANGE_DAYS    = 360;  // max days to keep in memory
export const TOOLBAR_H = 40;
export const EVENT_PAD    = 3;
export const DAYS_OF_WEEK = ['Sun','Mon','Tue','Wed','Thu','Fri','Sat'];

export const MS            = 86400000; // milliseconds in one day
